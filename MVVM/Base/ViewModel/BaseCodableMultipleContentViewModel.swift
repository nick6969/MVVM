//
//  BaseCodableMultipleContentViewModel.swift
//  MVVM
//
...
class BaseCodableMultipleContentViewModel<T>: ViewModelMultipleContentDataProtocol where T: MultipleContentProtocol {
